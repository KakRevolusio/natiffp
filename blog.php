...
$id = isset($_GET['edit_perusahaan']) ? $_GET['edit_perusahaan'] : null;

// Fungsi untuk mendapatkan satu data perusahaan dari database berdasarkan ID
...
$perusahaan = getPerusahaan($id);

// Proses pengolahan form edit perusahaan
