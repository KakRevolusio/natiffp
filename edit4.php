...
function getprogamer($id)
{
    global $conn;
    $id = mysqli_real_escape_string($conn, $id);
    $query = "SELECT * FROM progamer WHERE id = '$id'";
    $result = mysqli_query($conn, $query);
    $progamer = mysqli_fetch_assoc($result);
    ...
    <div class="container">
        ...
        <form method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $progamer['nama']; ?>">
            </div>
            <div class="form-group">
                <label for="jabatan">Jabatan:</label>
                <textarea class="form-control" id="jabatan" name="jabatan"><?php echo $progamer['jabatan']; ?></textarea>
            </div>
            <input type="hidden" name="id" value="<?php echo $progamer['id']; ?>">
