      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="dropdown1">
            <li>
              <a class="dropdown-item" href="./struktur.php">Struktur Perusahaan</a>
              <a class="dropdown-item" href="visimisi.php">Visi Misi</a>
              <a class="dropdown-item" href="#">Manajemen</a>
              <a class="dropdown-item" href="./latar.php">Latar Perusahaan</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item dropdown-toggle" href="devisi.php">Devisi Bagian</a>
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="./progaming.php">Pemograman</a></li>
                <li><a class="dropdown-item" href="./marketing.php">Marketing</a></li>
                <li><a class="dropdown-item" href="./lapangan.php">Lapangan</a></li>
              </ul>
              <a class="dropdown-item" href="kebijakan.php">Kebijakan Perusahaan</a>
            </li>
          </ul>
        </li>
        <li class="nav-item dropdown">
